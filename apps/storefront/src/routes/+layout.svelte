<script lang="ts">
	import { AppBar, Button, Tooltip, settings } from 'svelte-ux';
	import '../app.postcss';
...
<AppBar title="Svelte UX Starter" menuIcon={null}>
...
<main class="p-2 grid place-items-center content-center bg-surface-100 h-[calc(100vh-64px)]">
	<slot />
</main>
